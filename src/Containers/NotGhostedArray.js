export const notGhostedArray = [
    ...
    "Sometimes it's just a mutual decision to never speak again, that's where you are, even if you haven't realized it yet.",
    "Every rejection is just leading you closer to acceptance.",
    "You're a bad b*tch, get back out there!",
    "Dating is hard, but you weren't ghosted, so keep on going!",
    "They didn't text you, true, but did you text them?"
]